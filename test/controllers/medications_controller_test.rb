...
class MedicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medication" do
    assert_difference('Medication.count') do
      post medications_url, params: { medication: { name: @medication.name, quantity: @medication.quantity } }
    end
  ...
  test "should update medication" do
    patch medication_url(@medication), params: { medication: { name: @medication.name, quantity: @medication.quantity } }
